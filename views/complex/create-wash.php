...
$this->params['mobileFixedMenuBackUrl'] = '/complex/wash';
...
<script>
    $(document).ready(function () {
        ...
        $('#goToSecondStep').click(function () {
            ...
            //TODO: Валидация заполненности названия комплекса
            ...
            $('.header-page-title').text('Параметры комплекса');
        });
        ...
        $('.complex-time--row input').on('change', function (item) {
            if ($('#mainInfoBlock').hasClass('initiated-time')) {
                let currentValue = $(this).val();
                $('.complex-time--row input').each(function (index, item) {
                    $(item).val(currentValue);
                })
                $('#mainInfoBlock').removeClass('initiated-time');
            }
        });

        $('.complex-price--row input').on('change', function (item) {
            if ($('#mainInfoBlock').hasClass('initiated-price')) {
                let currentValue = $(this).val();
                $('.complex-price--row input').each(function (index, item) {
                    $(item).val(currentValue);
                })
                $('#mainInfoBlock').removeClass('initiated-price');
            }
        });
