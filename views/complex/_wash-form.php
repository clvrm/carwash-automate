            ...
            <div class="card-body">
                <div class="row mt-6">
                    <div class="col-lg-12">
                        ...
                        <div class="complex-time--row form-group row mt-3 ">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="input-group">
                                        <?= Html::activeInput('number', $model, 'type_' . $carTypeId . '_time', ['class' => 'form-control',
                                            'placeholder' => 'мин', 'required' => false, 'min' => 0]) ?>
                ...
                <div class="row mt-6">
                    <div class="col-lg-12">
                        <h6 class="font-weight-normal"><i class="fas fa-tag mr-4 text-primary"></i>Цена комплекса
                            для каждого типа ТС</h6>
