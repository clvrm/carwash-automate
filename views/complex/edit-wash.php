...
$this->title = 'Обновление комплекса';
...
$arrayMapSelectedMaterialsIds = ArrayHelper::map($selectedMaterials, 'id', 'material_id');
                ...
                <div data-scroll="true" data-height="300">
                    ...
                    <?php foreach ($materials as $material) : ?>
                        <div class="modal-material-list--item d-flex service-material--info"
                             data-id="<?= $material->id ?>"
                            <?= in_array($material->id, $arrayMapSelectedMaterialsIds) ? 'style="display:none !important;"' : '' ?>>
