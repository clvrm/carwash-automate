...
<script>
    $(document).ready(function () {
        ...
        $('.service-time--row input').on('change', function (item) {
            if ($('#serviceCreate').hasClass('initiated-time')) {
                let currentValue = $(this).val();
                $('.service-time--row input').each(function (index, item) {
                    $(item).val(currentValue);
                })
                $('#serviceCreate').removeClass('initiated-time');
            }
        });

        $('.service-price--row input').on('change', function (item) {
            if ($('#serviceCreate').hasClass('initiated-price')) {
                let currentValue = $(this).val();
                $('.service-price--row input').each(function (index, item) {
                    $(item).val(currentValue);
                })
                $('#serviceCreate').removeClass('initiated-price');
            }
        });
    });
