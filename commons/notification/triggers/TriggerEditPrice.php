...
class TriggerEditPrice extends NotifyTrigger
{
    protected $eventName = PersonalNotification::EVENT_EDIT_PRICE_LIST;
    ...
    public function prepare()
    {
        ...
        $this->defaultTitle = $this->pushTitle = 'Прайс изменен';
