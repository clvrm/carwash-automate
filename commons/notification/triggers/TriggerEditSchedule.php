...
class TriggerEditSchedule extends NotifyTrigger
{
    protected $eventName = PersonalNotification::EVENT_EDIT_SCHEDULE;
    ...
    public function prepare()
    {
        ...
        $this->defaultTitle = $this->pushTitle = 'Настройки для клиента вашей автомойки изменены';
